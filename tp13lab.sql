...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2023 a las 03:16:44
...
--
-- Base de datos: `tp13lab`
--
CREATE DATABASE IF NOT EXISTS `tp13lab` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tp13lab`;
...
(1, 42207610, 'sepulveda', 'santy', '1999-09-29', 1),
(2, 9847512, 'Garibotto', 'Coni', '1998-03-20', 1),
(3, 6846512, 'Flores', 'Julio', '2001-02-14', 1);
...
--
ALTER TABLE `inscripcion`
  MODIFY `idInscripto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
